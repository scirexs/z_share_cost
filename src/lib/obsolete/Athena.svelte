<script context="module" lang="ts">
  ...
  import { EStyleSize, EStyleFlexibility, EStyleFlexAlignMainAxis } from "$lib/obsolete/constants";
  import { mergeStyle } from "$lib/obsolete/gfunctions";
  import Tabs, { layoutTabs, styleTabs, styleActive, styleFrame } from "$lib/obsolete/_Tabs.svelte";
  import Descriptor, { styleDescriptor } from "$lib/obsolete/_Descriptor.svelte";
  import Button, { styleButton } from "$lib/obsolete/_Button.svelte";
  import TextBox, { styleTextBox } from "$lib/obsolete/_TextBox.svelte";
  import ChipInput from "$lib/obsolete/ChipInput.svelte";
  import { styleChip } from "$lib/obsolete/_Chip.svelte";
  import CostInput from "$lib/obsolete/CostInput.svelte";
  import { styleToggle } from "$lib/obsolete/_Toggle.svelte";
  import { styleSelect } from "$lib/obsolete/_Select.svelte";
  import { styleAccordion } from "$lib/obsolete/_Accordion_c.svelte";
  import Details from "$lib/obsolete/Details.svelte";
  import Result from "$lib/obsolete/Result.svelte";
</script>
