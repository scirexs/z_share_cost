<script context="module" lang="ts">
  ...
  import type { Tag, TagStyle } from "$lib/obsolete/zTagPanel.svelte";
  import { InputType, type InputMode, type TextBoxStyle } from "$lib/obsolete/zTextBox.svelte";
  import TagPanel from "$lib/obsolete/zTagPanel.svelte";
  import TextBox from "$lib/obsolete/zTextBox.svelte";
  class MyStyle {
